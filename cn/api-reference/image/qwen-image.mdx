...
- **3.0 Pro** — 3 代旗舰,面向密集信息排版 —— 餐厅菜单、商品表、多栏版式、分镜稿,1K / 2K 分档计价
- **3.0** — 3 代标准档,文字渲染明显更稳,中英文标题与正文在海报、密排场景下都更可读,1K / 2K 同价
- **2.0 Pro** — 2 代旗舰最高保真档,原生 2K、强细节、准确构图、专业级文字渲染,适合信息图、海报、营销资产
- **2.0** — 2 代标准版,集成生成和编辑能力,支持超长提示词,2K 高质量输出
...
| 模型 ID | 说明 |
|---|---|
| `qwen-image-3.0-pro` | 3 代旗舰,密集信息排版(菜单 / 商品表 / 多栏),1K 与 2K 分档计价 |
| `qwen-image-3.0` | 3 代标准档,文字渲染更稳,1K / 2K 同价 |
