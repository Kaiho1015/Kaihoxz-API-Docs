...
- **grok-imagine-1.0-rev** / **grok-imagine-1.5-rev** — 文生图(`generate`),纯文本提示出图
- **grok-imagine-1.0-edit-rev** / **grok-imagine-1.5-edit-rev** — 图像编辑(需传 `image_urls` 参考图)
...
| 模型 ID | 类型 | 说明 |
|---|---|---|
| `grok-imagine-1.0-rev` | 文生图 | Grok Imagine 1.0,纯文本提示生成图像,支持 5 种宽高比 |
| `grok-imagine-1.5-rev` | 文生图 | Grok Imagine 1.5,新一代文生图,支持 5 种宽高比 |
| `grok-imagine-1.0-edit-rev` | 图像编辑 | Grok Imagine 1.0 图像编辑,需传入参考图 `image_urls` |
| `grok-imagine-1.5-edit-rev` | 图像编辑 | Grok Imagine 1.5 图像编辑,需传入参考图 `image_urls` |

## 通用参数

<ParamField body="model" type="string" required>
  从 [可用模型](#可用模型) 列表中选一个。文生图用 `grok-imagine-1.0-rev` / `grok-imagine-1.5-rev`;图像编辑用 `grok-imagine-1.0-edit-rev` / `grok-imagine-1.5-edit-rev`
</ParamField>
