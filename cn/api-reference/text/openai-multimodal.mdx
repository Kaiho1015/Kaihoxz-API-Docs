---
title: "Responses 接口"
description: "OpenAI Responses 协议入口，服务 GPT Pro / Codex 与 o3-pro"
api: "POST https://www.qingbo.dev/v1/responses"
---

OpenAI Responses 协议入口，服务 `gpt-5-pro`、`gpt-5.2-pro`、`gpt-5.4-pro`、`gpt-5.3-codex` 与 `o3-pro` 五个模型。这五个模型不接受 Chat Completions，其余文本模型走[通用对话接口](/cn/api-reference/text/general-chat)。
