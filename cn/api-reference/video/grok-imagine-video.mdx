...
**两档可选** — `grok-imagine-1.0-video-rev`(1.0 基础档)、`grok-imagine-1.5-video-rev`(1.5 升级档)。两档能力一致:文生视频(T2V)/ 图生视频(I2V),480p / 720p,6-30 秒任意整数。
...
|---|---|---|---|---|
| `grok-imagine-1.0-video-rev` | 480p / 720p | 6-30 | generate | 基础档,T2V / I2V |
| `grok-imagine-1.5-video-rev` | 480p / 720p | 6-30 | generate | 升级档,T2V / I2V,与 1.0 同价 |

## 通用参数

<ParamField body="model" type="string" required>
  模型 ID,可选值:
  - `grok-imagine-1.0-video-rev`
  - `grok-imagine-1.5-video-rev`
</ParamField>
