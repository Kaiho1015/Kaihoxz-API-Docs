...
| 档位 | 渠道 | 计费方式 | 音频 | 定位 |
|---|---|---|---|---|
| `veo3.1-quality` | 官方线 | 按秒 | 支持 | 旗舰档,最终交付质量 |
| `veo3.1-fast` | 官方线 | 按秒 | 支持 | 加速档,适合迭代试稿 |
| `veo3.1-quality-rev` | 备用线 | 按秒 | 不支持 | 标准旗舰子型 |
| `veo3.1-fast-rev` | 备用线 | 按秒 | 不支持 | 标准加速子型 |
| `veo3.1-lite` | 标准接入 | 按秒 | 不支持 | 标准轻量子型,低成本批量 |
...
|---|---|---|---|---|---|
| `veo3.1-quality` | 官方线 | 按秒 | 8 秒(固定) | 720P / 1080P / 4K | 支持 |
| `veo3.1-fast` | 官方线 | 按秒 | 8 秒(固定) | 720P / 1080P / 4K | 支持 |
| `veo3.1-quality-rev` | 备用线 | 按秒 | 8 秒(固定) | 720P / 1080P / 4K | 不支持 |
| `veo3.1-fast-rev` | 备用线 | 按秒 | 8 秒(固定) | 720P / 1080P / 4K | 不支持 |
| `veo3.1-lite` | 标准接入 | 按秒 | 8 秒(固定) | 720P / 1080P / 4K | 不支持 |

## 通用参数

<ParamField body="model" type="string" required>
  模型 ID,可选 `veo3.1-quality` / `veo3.1-fast` / `veo3.1-quality-rev` / `veo3.1-fast-rev` / `veo3.1-lite`
</ParamField>
...
<Tabs>
  <Tab title="veo3.1-quality / veo3.1-fast(官方)">
  ...
  <Tab title="veo3.1-quality-rev / veo3.1-fast-rev(标准)">
    <ParamField body="generation_type" type="string">
      ...
      <Note>`veo3.1-quality-rev` 不支持 `reference` 模式。</Note>
    </ParamField>
