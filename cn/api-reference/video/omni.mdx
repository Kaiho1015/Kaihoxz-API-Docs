...
description: "Omni-Flash-Ext — 文生 / 视频续写统一模型,固定时长档,支持 4K"
...
**不带参考视频**时按 **分辨率 × 时长** 分档收整片价。

**带参考视频**(`video_urls`)时换一种收法:**只按参考视频秒数计费**,整片价**不收**。720p / 1080p 一档每秒单价,4K 另一档。参考视频最长 **10 秒**。
...
|---|---|---|---|---|
| `omni-flash-ext` | 720p / 1080p / 4k | 4 / 6 / 8 / 10 秒 | generate | 文生 / 视频续写统一入口 |
