...
api: "GET https://www.qingbo.dev/v1/dashboard/billing/subscription"
---
...
To get the remaining balance in one request, use [Get balance](/en/api-reference/account/balance).
