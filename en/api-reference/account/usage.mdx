...
api: "GET https://www.qingbo.dev/v1/dashboard/billing/usage"
---
...
If you just want the balance, [Get balance](/en/api-reference/account/balance) returns `total_available_usd` in a single request — no subtraction needed.
