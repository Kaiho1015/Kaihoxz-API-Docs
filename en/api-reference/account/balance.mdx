...
api: "GET https://www.qingbo.dev/v1/dashboard/billing/balance"
---
...
- This endpoint returns only your own data — no channel, upstream model or key material.

## Which of the three to use

| You want | Use |
|---|---|
| Balance, usage and total in one call | **This page** — recommended for new integrations |
...
The other two exist to stay compatible with **existing OpenAI credit-checking tools** (usage dashboards, cost-tracking scripts). When writing your own code, this endpoint is the direct one.
