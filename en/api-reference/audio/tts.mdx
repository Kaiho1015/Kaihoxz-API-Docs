...
<Warning>
`tts-1` and `tts-1-hd` were delisted on 2026-09-03; this page is kept for reference only. For text-to-speech, please wait for `gpt-4o-mini-tts` to launch
</Warning>
...
`tts-1` and `tts-1-hd` are delisted, so no model is currently available — please wait for `gpt-4o-mini-tts` to launch.

## Request Parameters

<ParamField body="model" type="string" required>
  Please wait for `gpt-4o-mini-tts` to launch
</ParamField>
