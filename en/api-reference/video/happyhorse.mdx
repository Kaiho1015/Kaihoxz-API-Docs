...
<ParamField body="duration" type="integer" default="5">
  Video duration in seconds, any integer in 3-15. **`0` is not accepted** — `0 = follow the source duration` is a `wan2.7-videoedit` convention and does not apply to this model
</ParamField>
