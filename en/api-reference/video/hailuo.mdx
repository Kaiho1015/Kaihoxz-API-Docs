...
curl -X POST https://www.qingbo.dev/v1/tasks \
  ...
  -d '{
    ...
    "image_urls": ["https://cdn.example.com/city-night.jpg"],
    "duration": 6,
    "resolution": "768p",
    "aspect_ratio": "16:9"
  }'
...
<ParamField body="image_urls" type="string[]">
  Reference image URL array; triggers **I2V** mode. Public URL or Base64. **Required** for `minimax-hailuo-2.3-fast` when doing image-to-video — If it is missing, the request is rejected at submission and nothing is held.
</ParamField>
