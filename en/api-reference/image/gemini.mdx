...
<Tabs>
  ...
  <Tab title="3.1 Flash">
    ...
    **Highlights**: Lightweight fast tier — low latency, low cost, from the `0.5K` economy tier up to `4K`, ideal for previewing, batches, and iteration. **Exclusive support for Google text and image search augmentation**, generating images grounded in real-time web information.
