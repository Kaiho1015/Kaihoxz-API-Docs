...
Alibaba Tongyi Qianwen image series — **two generations, four tiers**:

- **3.0 Pro** — Gen-3 flagship, built for dense information layouts: restaurant menus, product tables, multi-column pages, storyboards. 1K and 2K are priced separately
- **3.0** — Gen-3 standard. Markedly more reliable text rendering — headlines and body copy stay legible in both Chinese and English on posters and dense layouts. Same price at 1K and 2K
- **2.0 Pro** — Gen-2 flagship highest-fidelity tier. Native 2K, strong detail, accurate composition, professional-grade text rendering
- **2.0** — Gen-2 standard. Combined generation and editing, supports very long prompts, 2K high-quality output
...
|---|---|
| `qwen-image-3.0-pro` | Gen-3 flagship for dense layouts (menus / product tables / multi-column). 1K and 2K priced separately |
| `qwen-image-3.0` | Gen-3 standard, more reliable text rendering, same price at 1K and 2K |
