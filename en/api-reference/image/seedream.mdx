...
- **4.5** — The refined 4.x tier: better text accuracy and multi-reference style fusion, 1K / 2K / 4K, up to 10 reference images and 15 images per request
...
| `seedream-4.5` | Refined 4.x tier, better text accuracy and multi-reference fusion, 1K / 2K / 4K |
