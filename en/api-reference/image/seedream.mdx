...
- **5.0 Pro** — Quality-first: cinematic detail and text accuracy, 1K / 2K, up to 10 reference images, 2K priced separately
...
|---|---|
| `seedream-5.0-pro` | Quality-first tier, cinematic detail, 1K / 2K (2K priced separately), up to 10 reference images |
