...
<Warning>
`imagen-4.0` was delisted on 2026-09-03; this page is kept for reference only. For Google image generation use the Nano Banana family ([Gemini image](/en/api-reference/image/gemini))
</Warning>
