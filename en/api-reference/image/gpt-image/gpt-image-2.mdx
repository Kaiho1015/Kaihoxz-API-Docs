...
Output token counts vary enormously. Here are the estimates for `1:1`; other ratios follow the same pattern (wider frames cost less — `16:9` 1K high is 4,312):

| Quality | 1K | 2K | 4K |
|---|---:|---:|---:|
| `low` | 196 | 397 | 659 |
| `medium` | 1,756 | 3,568 | 5,930 |
| `high` | 7,024 | 14,272 | 23,719 |

At $27 per million tokens, the output for `1:1 1K low` is about $0.005 and `1:1 4K high` about $0.64 — **quality is by far the biggest cost lever on this line**, so start with `low` when unsure.
