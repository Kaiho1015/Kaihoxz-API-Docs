...
|---|---|
| `gpt-image-2-rev` | Flagship new release, 13 ratios × 1K/2K/4K, up to 16 reference images |
| `gpt-image-1` | Multimodal text + image understanding, suited for high-quality generation and editing |
